...
# Understory Imaging Vello CPU

**Vello CPU backend for Understory imaging IR**

[![Latest published version.](https://img.shields.io/crates/v/understory_imaging_vello_cpu.svg)](https://crates.io/crates/understory_imaging_vello_cpu)
[![Documentation build status.](https://img.shields.io/docsrs/understory_imaging_vello_cpu.svg)](https://docs.rs/understory_imaging_vello_cpu)
...
cargo rdme --workspace-project=understory_imaging_vello_cpu
